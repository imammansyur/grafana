...
require (
	...
	github.com/grafana/authlib v0.0.0-20260512161930-98d27554449f // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20260512161930-98d27554449f // @grafana/identity-access-team
